        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <p className="text-lg text-gray-300 leading-relaxed">
              I am an aspiring MLE and AI Software Engineer.
...
My technical expertise spans Python, OpenCV, NLP, Docker, and cloud platforms such as Azure, enabling me to design, build, and deploy scalable AI solutions from the ground up. I have extensive experience working with Large Language Models (LLMs), HFTs, and multimodal learning frameworks.
